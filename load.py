...
def load(torch_dataset, input_channels, batch_size):
    ...
    train_ds = torch_dataset(root="data/", train=True, download=True, transform=transform)
    valid_ds = torch_dataset(root="data/", train=False, download=True, transform=transform)
